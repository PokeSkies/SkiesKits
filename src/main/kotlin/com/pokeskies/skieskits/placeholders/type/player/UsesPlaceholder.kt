...
class UsesPlaceholder : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        if (!ConfigManager.KITS.containsKey(kitId)) {
            return GenericResult.invalid("Kit Not Found")
        }
        ...
        return GenericResult.valid(kitData.uses)
    }

    override fun id(): List<String> = listOf("uses")
}

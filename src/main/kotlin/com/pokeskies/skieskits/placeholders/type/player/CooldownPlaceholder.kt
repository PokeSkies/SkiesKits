...
class CooldownPlaceholder : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        return GenericResult.valid(Utils.getFormattedTime(kitData.getTimeRemaining(kit.cooldown)))
    }

    override fun id(): List<String> = listOf("cooldown")
}

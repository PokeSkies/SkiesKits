...
class IsOnCooldownPlaceholder : PlayerPlaceholder {
    override fun handle(player: ServerPlayer, args: List<String>): GenericResult {
        ...
        return GenericResult.valid(!kitData.canClaimCooldown(kit.cooldown))
    }

    override fun id(): List<String> = listOf("is_on_cooldown")
}
